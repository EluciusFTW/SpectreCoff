...
type CanvasImageExample() =
    ...
    override _.Execute(_context, _settings, _) =
        ...
        task {
            ...
            let! response =
                client.GetByteArrayAsync("https://upload.wikimedia.org/wikipedia/commons/5/57/Fsharp_logo.png")
            ...
            Many [
                ...
                P "Take full advantage of "
                LinkWithLabel("ImageSharp", "https://github.com/SixLabors/ImageSharp")
                P "to manipulate your images!"
