...
let main argv =
    ...
    app.Configure(fun config ->
        config.AddBranch(
            "output",
            fun (branchConfig: IConfigurator<OutputSettings>) ->
                branchConfig
        ...
        config.AddBranch(
            "table",
            fun (branchConfig: IConfigurator<TableSettings>) ->
                branchConfig
        ...
        config.AddBranch(
            "rule",
            fun (branchConfig: IConfigurator<RuleSettings>) ->
                branchConfig
        ...
        config.AddBranch(
            "figlet",
            fun (branchConfig: IConfigurator<FigletSettings>) ->
                branchConfig
        ...
        config.AddBranch(
            "prompt",
            fun (branchConfig: IConfigurator<PromptSettings>) ->
                branchConfig
        ...
        config.AddBranch(
            "panel",
            fun (branchConfig: IConfigurator<PanelSettings>) ->
                branchConfig
        ...
        config.AddBranch(
            "bar",
            fun (branchConfig: IConfigurator<BarChartSettings>) ->
                branchConfig
        ...
        config.AddBranch(
            "breakdown",
            fun (branchConfig: IConfigurator<BreakdownChartSettings>) ->
                branchConfig
        ...
        config.AddBranch(
            "tree",
            fun (branchConfig: IConfigurator<TreeSettings>) ->
                branchConfig
        ...
        config.AddBranch(
            "calendar",
            fun (branchConfig: IConfigurator<CalendarSettings>) ->
                branchConfig
        ...
        config.AddBranch(
            "padder",
            fun (branchConfig: IConfigurator<PadderSettings>) ->
                branchConfig
        ...
        config.AddBranch(
            "grid",
            fun (branchConfig: IConfigurator<GridSettings>) ->
                branchConfig
        ...
        config.AddBranch(
            "textpath",
            fun (branchConfig: IConfigurator<TextpathSettings>) ->
                branchConfig
        ...
        config.AddBranch(
            "json",
            fun (branchConfig: IConfigurator<JsonSettings>) ->
                branchConfig
        ...
        config.AddBranch(
            "canvas",
            fun (branchConfig: IConfigurator<CanvasSettings>) ->
                branchConfig
        ...
        config.AddBranch(
            "canvasimage",
            fun (branchConfig: IConfigurator<CanvasImageSettings>) ->
                branchConfig
        ...
        config.AddBranch(
            "layout",
            fun (branchConfig: IConfigurator<LayoutSettings>) ->
                branchConfig
        ...
        config.AddBranch(
            "live-display",
            fun (branchConfig: IConfigurator<LiveDisplaySettings>) ->
                branchConfig
        ...
        config.AddBranch(
            "progress",
            fun (branchConfig: IConfigurator<ProgressSettings>) ->
                branchConfig
        ...
        config.AddBranch(
            "status",
            fun (branchConfig: IConfigurator<StatusSettings>) ->
                branchConfig
        ...
        config.AddBranch(
            "dumpify",
            fun (branchConfig: IConfigurator<DumpifySettings>) ->
                branchConfig
        ...
        config.AddBranch(
            "theme",
            fun (add: IConfigurator<ThemeSettings>) ->
                add.AddCommand<ThemeExample>("example").WithDescription("Shows example output for the given theme")
                |> ignore

                add.AddCommand<ListThemes>("list").WithDescription("Shows a list of built-in themes")
                |> ignore
        )
        |> ignore)
